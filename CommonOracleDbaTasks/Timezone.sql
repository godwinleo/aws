...
The alter_db_time_zone procedure changes the time zone for only certain data types, and doesnt change SYSDATE. There are additional restrictions on setting the time zone listed in the Oracle documentation.
